        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('index')); ?>"><?php echo e(__('Home')); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('products')); ?>"><?php echo e(__('Products')); ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo e(route('cart')); ?>"><?php echo e(__('Cart')); ?></a>
                            </li>
                            <li class="nav-item">
